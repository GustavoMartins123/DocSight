...
- Document the measured cost structure: about 26 ms of process startup per invocation, pixel-linear rasterization at about 40 ns per pixel dominating engine time on small pages, a 29-page cache win from 74 ms to 38 ms, and about 100 ms of Windows sandbox overhead per call, guiding clients toward fewer, larger invocations.
